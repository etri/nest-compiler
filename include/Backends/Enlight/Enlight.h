...
class Enlight final : public BackendUsingGlowIR,
 ...
 public:
  ...
  size_t getTraceEventDataSize() const override {
    return Enlight::getTraceEventDataSizeStatic();
  }

  runtime::DeviceManager *
  createDeviceManager(const runtime::DeviceConfig &deviceConfig) override {
    return createEnlightDeviceManager(deviceConfig);
  }
