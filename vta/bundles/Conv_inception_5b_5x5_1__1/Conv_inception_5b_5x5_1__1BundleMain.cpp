...
int main(int argc, char **argv) {
    ...
    int8_t *constantWeightVarsAddr =
            initConstantWeights("Conv_inception_5b_5x5_1__1Bundle.weights.bin", Conv_inception_5b_5x5_1__1Bundle_config);
    int8_t *mutableWeightVarsAddr = initMutableWeightVars(Conv_inception_5b_5x5_1__1Bundle_config);
    int8_t *activationsAddr = initActivations(Conv_inception_5b_5x5_1__1Bundle_config);

  Conv_inception_5b_5x5_1__1MainEntry_load_module((uint8_t*)constantWeightVarsAddr);

    // Perform the computation.
    int errCode =
        Conv_inception_5b_5x5_1__1MainEntry((uint8_t*)constantWeightVarsAddr, (uint8_t*)mutableWeightVarsAddr, (uint8_t*)activationsAddr);
    if (errCode != GLOW_SUCCESS) {
        printf("Error running bundle: error code %d\n", errCode);
    }

    // Report the results.
    dumpInferenceResults(Conv_inception_5b_5x5_1__1Bundle_config, mutableWeightVarsAddr);

  Conv_inception_5b_5x5_1__1MainEntry_destroy_module();
    // Free all resources.
