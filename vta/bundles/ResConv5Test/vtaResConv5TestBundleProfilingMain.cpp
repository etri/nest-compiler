...
int main(int argc, char **argv) {
  ...
  freopen("ResConv5Test.csv", "w", stdout);
  printf("1,28,28,128,256,1,1,0,2,0,1,6,14,14,%d,%d,%d", input1, input2, input3);
  fclose(stdout);

  freopen("ResConv5Test.csv", "a+", stdout);
  printf(",");
  ...
  int errCode =
      vtaResConv5TestMainEntry((uint8_t*)constantWeightVarsAddr, (uint8_t*)mutableWeightVarsAddr, (uint8_t*)activationsAddr, input1, input2, input3);
