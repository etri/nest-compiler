...
#ifndef GLOW_NewtonSAVER_H
#define GLOW_NewtonSAVER_H


#include <string>

std::string const Newton_BUNDLE_HEADER_0 =R"~(
...
std::string const Newton_BUNDLE_HEADER_1 =R"~(
#ifdef __cplusplus
}
#endif
)~";

#endif //GLOW_NewtonSAVER_H
