 ...
 */
#ifndef NESTC_NEWTON_TESTS_BACKENDTESTUTILS_H
#define NESTC_NEWTON_TESTS_BACKENDTESTUTILS_H
  ...
  bool generateInst(Node *N, IRGenVisitor &irgen) const override {
    ...
    case glow::Kinded::Kind::ConvolutionNodeKind: {
      ...
      auto *V = builder_->createConvolutionInst(
          ...
          CN__->getFusedActivation(), CN__->getFusedActivationArgs());
      if (N->hasPredicate()) {
...
#endif // NESTC_NEWTON_TESTS_BACKENDTESTUTILS_H
