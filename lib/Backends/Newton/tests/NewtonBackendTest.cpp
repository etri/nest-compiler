...
//  Tensor out1(ElemKind::FloatTy, shape);
//  Tensor out2(ElemKind::FloatTy, shape);
//  inferFCReluNet(&inputs, &filter, &bias, &out1, "Interpreter");
//  inferFCReluNet(&inputs, &filter, &bias, &out2, "Newton");
//  //out1.toBin("golden");
//  EXPECT_TRUE(out1.isEqual(out2, 1));
//}
