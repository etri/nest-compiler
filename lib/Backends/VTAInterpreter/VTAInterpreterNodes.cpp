...
#include "glow/Backends/VTAInterpreter/VTAInterpreter.h"
...
void BoundVTAInterpreterFunction::fwdBatchMatMulInst(
  ...
  DCHECK(!"Found BatchMatMulInst but BatchMatMul is lowered on VTAInterpreter");
}

void BoundVTAInterpreterFunction::fwdReluGradInst(const glow::ReluGradInst *I) {
  DCHECK(!"Found ReluGradInst but ReluGrad is lowered on VTAInterpreter");
}
...
template <typename ElemTy>
void BoundVTAInterpreterFunction::fwdBatchedReduceAddInstFloatImpl(
...
template <typename ElemTy>
void BoundVTAInterpreterFunction::fwdSparseToDenseInstImpl(
...
void BoundVTAInterpreterFunction::fwdSparseToDenseInst(
    const SparseToDenseInst *I) {
