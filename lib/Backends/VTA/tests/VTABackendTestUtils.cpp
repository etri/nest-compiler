...
void inferElemAddNet(Tensor *inputs0, Tensor *inputs1, Tensor *out,
  ...
  auto *result = F->createSave("ret", elemadd, outP);
  auto *resultTensor = bindings.get(result->getPlaceholder());
...
void inferElemSubNet(Tensor *inputs0, Tensor *inputs1, Tensor *out,
                     llvm::StringRef kind) {
  PlaceholderBindings bindings;
  ExecutionEngine EE(kind);
  auto &mod = EE.getModule();
  ...
  auto *result = F->createSave("ret", elemsub, outP);
  auto *resultTensor = bindings.get(result->getPlaceholder());
...
void inferElemDivNet(Tensor *inputs0, Tensor *inputs1, Tensor *out,
                     llvm::StringRef kind) {
  PlaceholderBindings bindings;
  ExecutionEngine EE(kind);
  auto &mod = EE.getModule();
  ...
  auto *result = F->createSave("ret", elemdiv, outP);
  auto *resultTensor = bindings.get(result->getPlaceholder());
...
void inferDequantizeNet(Tensor *inputs, Tensor *out,
  ...
  auto *result = F->createSave("ret", dequantize, outP);
  auto *resultTensor = bindings.get(result->getPlaceholder());
