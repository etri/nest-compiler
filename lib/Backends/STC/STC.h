...
/// execute the instructions one at a time.
    class STC final : public BackendUsingGlowIR,
    ...
    public:
        ...
        size_t getTraceEventDataSize() const override {
            return STC::getTraceEventDataSizeStatic();
        }

        runtime::DeviceManager *
        createDeviceManager(const runtime::DeviceConfig &deviceConfig) override {
            return createSTCDeviceManager(deviceConfig);
        }
