 ...
 */
#ifndef GLOW_BACKENDS_STC_STCFUNCTION_H
#define GLOW_BACKENDS_STC_STCFUNCTION_H
...
/// Function "compiled" for execution by the STC.
    class STCFunction final : public CompiledFunction,
    ...
    public:
        STCFunction(std::unique_ptr<IRFunction> F,
                    runtime::RuntimeBundle &&bundle);

        /// \name CompiledFunction interface
        ///@{
        ~STCFunction() override;
...
/// An STCFunction bound to a specific invocation.
    class BoundSTCFunction : public IRInstructionProcessingHandler {
        ...
        /// A reference to the constant map from the owning STCFunction.
        const std::unordered_map<std::string, Tensor *> &constants_;

    public:
        explicit BoundSTCFunction(
    ...
    private:
        ...
        /// @name BoundSTCFunction methods. This is a list of method
        /// declerations that are used by the STC to dispatch different
        /// instructions.
        ///@{
...
#endif // GLOW_BACKENDS_STC_STCFUNCTION_H
