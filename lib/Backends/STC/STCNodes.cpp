...
void BoundSTCFunction::fwdConvolutionInstFloatImpl(
...
void BoundSTCFunction::fwdConvolutionInstQuantizedImpl(
        Value *inV, Value *outV, Value *filterV, Value *biasV,
        llvm::ArrayRef<unsigned_t> kernelSizes, llvm::ArrayRef<unsigned_t> strides,
        llvm::ArrayRef<unsigned_t> pads, size_t group, size_t dilation) {
    auto inW = getWeightHandle<ElemTy>(inV);
...
template <typename ElemTy>
void BoundSTCFunction::fwdConvTransposeInstFloatImpl(
        Value *inV, Value *outV, Value *filterV, Value *biasV,
        llvm::ArrayRef<unsigned_t> kernelSizes, llvm::ArrayRef<unsigned_t> strides,
        llvm::ArrayRef<unsigned_t> pads, size_t group, size_t dilation) {
    staticAssertFloatingPointType(ElemTy);
...
void BoundSTCFunction::fwdConvTransposeInst(
...
void BoundSTCFunction::fwdConvolutionInst(const ConvolutionInst *I) {
    auto kernelSizes = I->getKernels();
    auto pads = I->getPads();
    auto strides = I->getStrides();
    size_t group = I->getGroup();
...
void BoundSTCFunction::fwdConvolutionGradInst(
...
template <typename ElemTy>
void BoundSTCFunction::fwdConvolution3DInstFloatImpl(
        Value *inV, Value *outV, Value *filterV, Value *biasV,
        llvm::ArrayRef<unsigned_t> kernelSizes, llvm::ArrayRef<unsigned_t> strides,
...
template <typename ElemTy, typename AccumulatorTy, typename BiasElemTy>
void BoundSTCFunction::fwdConvolution3DInstQuantizedImpl(
        Value *inV, Value *outV, Value *filterV, Value *biasV,
        llvm::ArrayRef<unsigned_t> kernelSizes, llvm::ArrayRef<unsigned_t> strides,
        llvm::ArrayRef<unsigned_t> pads, size_t group) {
    auto inW = getWeightHandle<ElemTy>(inV);
...
void BoundSTCFunction::fwdConvolution3DInst(
...
void BoundSTCFunction::fwdConvolution3DGradInst(
...
//===----------------------------------------------------------------------===//
template <typename ElemTy, typename AccumulatorTy, typename BiasElemTy>
void BoundSTCFunction::fwdChannelwiseQuantizedConv2DInstImpl(
...
template <typename ElemTy, typename AccumulatorTy, typename BiasElemTy>
void BoundSTCFunction::fwdChannelwiseQuantizedConv3DInstImpl(
    const ChannelwiseQuantizedConvolutionInst *I) {
  auto inW = getWeightHandle<ElemTy>(I->getSrc());
  auto outW = getWeightHandle<ElemTy>(I->getDest());
  auto filterW = getWeightHandle<ElemTy>(I->getFilter());
...
void BoundSTCFunction::fwdChannelwiseQuantizedConvolutionInst(
    const ChannelwiseQuantizedConvolutionInst *I) {
...
void BoundSTCFunction::fwdMaxPoolInst(const MaxPoolInst *I) {
...
void BoundSTCFunction::fwdMaxPoolWithArgmaxInst(
...
template <typename ElemTy>
void BoundSTCFunction::fwdAvgPoolInstFloatImpl(const AvgPoolInst *I) {
    staticAssertFloatingPointType(ElemTy);
...
void BoundSTCFunction::fwdAvgPoolInstI8Impl(const AvgPoolInst *I) {
    ShapeNHWC odim(I->getDest()->dims());
    ShapeNHWC idim(I->getSrc()->dims());
...
void BoundSTCFunction::fwdAvgPoolInst(const AvgPoolInst *I) {
    if (I->getSrc()->getType()->isQuantizedType()) {
...
template <typename ElemTy>
void BoundSTCFunction::fwdAdaptiveAvgPoolInstFloatImpl(
...
void BoundSTCFunction::fwdAdaptiveAvgPoolInstI8Impl(
        const AdaptiveAvgPoolInst *I) {
    ShapeNHWC odim(I->getDest()->dims());
    ShapeNHWC idim(I->getSrc()->dims());
...
void BoundSTCFunction::fwdAdaptiveAvgPoolInst(
        const AdaptiveAvgPoolInst *I) {
    if (I->getSrc()->getType()->isQuantizedType()) {
...
void BoundSTCFunction::fwdAdaptiveAvgPoolGradInst(
...
void BoundSTCFunction::fwdMaxPoolWithArgmaxGradInst(
...
void BoundSTCFunction::fwdAvgPoolGradInst(const AvgPoolGradInst *I) {
    auto inG = getWeightHandle(I->getSrcGrad());
    auto outW = getWeightHandle(I->getDest());
    auto outG = getWeightHandle(I->getDestGrad());
...
void BoundSTCFunction::fwdReluInst(const ReluInst *) {
    DCHECK(!"Found ReluInst but Relu is lowered on STC");
}

template <typename ElemTy>
void BoundSTCFunction::fwdSigmoidInstFloatImpl(const SigmoidInst *I) {
    staticAssertFloatingPointType(ElemTy);
...
void BoundSTCFunction::fwdSigmoidInst(const SigmoidInst *I) {
    dispatchFloatingPointImpl(fwdSigmoidInstFloatImpl,
                              I->getSrc()->getElementType(), I);
}

template <typename ElemTy>
void BoundSTCFunction::fwdTanhInstFloatImpl(const TanhInst *I) {
    staticAssertFloatingPointType(ElemTy);
...
void BoundSTCFunction::fwdTanhInst(const TanhInst *I) {
...
template <typename ElemTy>
void BoundSTCFunction::fwdSoftMaxInstImpl(const SoftMaxInst *I) {
    staticAssertFloatingPointType(ElemTy);
...
void BoundSTCFunction::fwdSoftMaxInst(const SoftMaxInst *I) {
    dispatchFloatingPointImpl(fwdSoftMaxInstImpl, I->getSrc()->getElementType(),
                              I);
}

void BoundSTCFunction::fwdSoftMaxGradInst(const SoftMaxGradInst *I) {
    auto inG = getWeightHandle(I->getSrcGrad());
    auto idim = inG.dims();
...
template <typename ElemTy>
void BoundSTCFunction::fwdCrossEntropyLossInstFloatImpl(
...
void BoundSTCFunction::fwdCrossEntropyLossInst(
        const CrossEntropyLossInst *I) {
    dispatchFloatingPointImpl(fwdCrossEntropyLossInstFloatImpl,
                              I->getP()->getElementType(), I);
}

void BoundSTCFunction::fwdCrossEntropyLossGradInst(
...
void BoundSTCFunction::fwdCopyInst(const CopyInst *I) {
    auto inT = getTensor(I->getSrc());
    auto outT = getTensor(I->getDest());
    outT->copyRawFrom(inT);
}

void BoundSTCFunction::fwdTransposeInst(const TransposeInst *I) {
    auto inT = getTensor(I->getSrc());
    (void)inT;
    auto outT = getTensor(I->getDest());
...
void BoundSTCFunction::fwdTensorViewInst(const TensorViewInst *I) {
    getOrCreateUnownedTensor(I, I->getSrc(), I->getOffsets());
}

void BoundSTCFunction::fwdSplatInst(const glow::SplatInst *I) {
...
void BoundSTCFunction::fwdTouchInst(const glow::TouchInst *) {
    // Do nothing for a TouchInst
}

void BoundSTCFunction::fwdInsertTensorInst(
...
void BoundSTCFunction::fwdExtractTensorInst(
...
template <typename ElemTy>
void BoundSTCFunction::fwdGatherInstImpl(const glow::GatherInst *I) {
...
void BoundSTCFunction::fwdGatherInst(const glow::GatherInst *I) {
...
template <typename ElemTy>
void BoundSTCFunction::fwdGatherRangesInstImpl(
...
void BoundSTCFunction::fwdGatherRangesInst(
        const glow::GatherRangesInst *I) {
...
template <typename ElemTy>
void BoundSTCFunction::fwdScatterDataInstCopyImpl(
...
template <typename ElemTy>
void BoundSTCFunction::fwdScatterDataInstAddFloatImpl(
        const glow::ScatterDataInst *I) {
    Tensor *dataT = getTensor(I->getData());
    Tensor *indicesT = getTensor(I->getIndices());
    Tensor *slicesT = getTensor(I->getSlices());
...
template <typename ElemTy>
void BoundSTCFunction::fwdScatterDataInstAddQuantizedImpl(
        const glow::ScatterDataInst *I) {
    Tensor *dataT = getTensor(I->getData());
    Tensor *indicesT = getTensor(I->getIndices());
    Tensor *slicesT = getTensor(I->getSlices());
...
void BoundSTCFunction::fwdScatterDataInst(
        const glow::ScatterDataInst *I) {
    if (I->getCumulative()) {
...
template <typename ElemTy>
void BoundSTCFunction::fwdBatchOneHotImpl(
...
void BoundSTCFunction::fwdBatchOneHotInst(
        const glow::BatchOneHotInst *I) {
    switch (I->getData()->getElementType()) {
        case ElemKind::Int64ITy:
...
template <typename ElemTy>
void BoundSTCFunction::fwdSpaceToDepthInstImpl(
...
void BoundSTCFunction::fwdSpaceToDepthInst(
        const glow::SpaceToDepthInst *I) {
...
template <typename ElemTy>
void BoundSTCFunction::fwdResizeNearestInstImpl(
...
void BoundSTCFunction::fwdResizeNearestInst(
        const ResizeNearestInst *I) {
...
template <typename ElemTy>
void BoundSTCFunction::fwdResizeBilinearInstImpl(
...
void BoundSTCFunction::fwdResizeBilinearInst(
        const ResizeBilinearInst *I) {
    if (getTensor(I->getSrc())->getType().isQuantizedType()) {
...
template <typename ElemTy>
void BoundSTCFunction::fwdLocalResponseNormalizationInstFloatImpl(
...
void BoundSTCFunction::fwdLocalResponseNormalizationInst(
        const LocalResponseNormalizationInst *I) {
    dispatchFloatingPointImpl(fwdLocalResponseNormalizationInstFloatImpl,
                              I->getSrc()->getElementType(), I);
}

void BoundSTCFunction::fwdLocalResponseNormalizationGradInst(
...
//===----------------------------------------------------------------------===//
void BoundSTCFunction::fwdElementAddInstI8Impl(
...
template <typename ElemTy>
void BoundSTCFunction::fwdElementAddInstArithmeticImpl(
        const ElementAddInst *I) {
...
void BoundSTCFunction::fwdElementAddInst(const ElementAddInst *I) {
...
template <typename ElemTy>
void BoundSTCFunction::fwdElementSubInstArithmeticImpl(
...
void BoundSTCFunction::fwdElementSubInst(const ElementSubInst *I) {
    if (getTensor(I->getLHS())->getType().isQuantizedType()) {
        auto destTy = I->getDest()->getType();
        auto lhsTy = I->getLHS()->getType();
        auto rhsTy = I->getRHS()->getType();
...
template <typename ElemTy>
void BoundSTCFunction::fwdElementMulInstArithmeticImpl(
...
void BoundSTCFunction::fwdElementMulInst(const ElementMulInst *I) {
    if (getTensor(I->getLHS())->getType().isQuantizedType()) {
        auto lhsTy = I->getLHS()->getType();
        auto rhsTy = I->getRHS()->getType();
        auto destTy = I->getDest()->getType();
...
void BoundSTCFunction::fwdElementDivInst(const ElementDivInst *I) {
    if (getTensor(I->getLHS())->getType().isQuantizedType()) {
        auto destTy = I->getDest()->getType();
        auto lhsTy = I->getLHS()->getType();
        auto rhsTy = I->getRHS()->getType();
...
void BoundSTCFunction::fwdElementMaxInstI8Impl(
...
template <typename ElemTy>
void BoundSTCFunction::fwdElementMaxInstArithmeticImpl(
        const ElementMaxInst *I) {
    staticAssertArithmeticType(ElemTy);
...
void BoundSTCFunction::fwdElementMaxInst(const ElementMaxInst *I) {
    if (getTensor(I->getLHS())->getType().isQuantizedType()) {
...
template <typename ElemTy>
void BoundSTCFunction::fwdElementMinInstArithmeticImpl(
...
void BoundSTCFunction::fwdElementMinInst(const ElementMinInst *I) {
    if (getTensor(I->getLHS())->getType().isQuantizedType()) {
        auto lhsTy = I->getLHS()->getType();
        auto rhsTy = I->getRHS()->getType();
        auto destTy = I->getDest()->getType();
...
void BoundSTCFunction::fwdElementCmpHelperImpl(
...
template <typename ElemTy, typename ElemOffsetTy, typename ElemScaleTy,
        typename CmpTy>
void BoundSTCFunction::fwdElementCmpLTEInstImpl(
...
void BoundSTCFunction::fwdElementCmpLTEInst(
        const ElementCmpLTEInst *I) {
...
template <typename ElemTy, typename ElemOffsetTy, typename ElemScaleTy,
        typename CmpTy>
void BoundSTCFunction::fwdElementCmpEQInstImpl(
...
void BoundSTCFunction::fwdElementCmpEQInst(const ElementCmpEQInst *I) {
    auto *T = getTensor(I->getLHS());
...
template <typename ElemTy, typename ElemOffsetTy, typename ElemScaleTy,
        typename CmpTy>
void BoundSTCFunction::fwdElementCmpLTInstImpl(
...
void BoundSTCFunction::fwdElementCmpLTInst(ElementCmpLTInst const *I) {
    auto *T = getTensor(I->getLHS());
    if (T->getType().isQuantizedType()) {
...
template <typename ElemTy>
void BoundSTCFunction::fwdElementPowInstFloatImpl(
...
void BoundSTCFunction::fwdElementPowInst(
...
template <typename ElemTy>
void BoundSTCFunction::fwdElementIsNaNInstFloatImpl(
...
void BoundSTCFunction::fwdElementIsNaNInst(
...
template <typename ElemTy>
void BoundSTCFunction::fwdElementLogInstFloatImpl(
...
void BoundSTCFunction::fwdElementLogInst(const ElementLogInst *I) {
    dispatchFloatingPointImpl(fwdElementLogInstFloatImpl,
                              I->getSrc()->getElementType(), I);
}

template <typename ElemTy>
void BoundSTCFunction::fwdElementExpInstFloatImpl(
...
void BoundSTCFunction::fwdElementExpInst(const ElementExpInst *I) {
    dispatchFloatingPointImpl(fwdElementExpInstFloatImpl,
                              I->getSrc()->getElementType(), I);
}

template <typename ElemTy>
void BoundSTCFunction::fwdElementSelectInstFloatImpl(
...
void BoundSTCFunction::fwdElementSelectInst(
        const glow::ElementSelectInst *I) {
    if (getTensor(I->getLHS())->getType().isQuantizedType()) {
        auto destTy = I->getDest()->getType();
        auto lhsTy = I->getLHS()->getType();
...
template <typename ElemTy>
void BoundSTCFunction::fwdModuloInstImpl(glow::ModuloInst const *I) {
...
void BoundSTCFunction::fwdModuloInst(glow::ModuloInst const *I) {
...
void BoundSTCFunction::fwdMatMulInstQuantizedImpl(
...
template <typename ElemTy>
void BoundSTCFunction::fwdMatMulInstFloatImpl(const MatMulInst *I) {
    staticAssertFloatingPointType(ElemTy);
...
void BoundSTCFunction::fwdMatMulInst(const glow::MatMulInst *I) {
    if (getTensor(I->getLHS())->getType().isQuantizedType()) {
...
void BoundSTCFunction::fwdBatchMatMulInst(
        const glow::BatchMatMulInst *I) {
    DCHECK(!"Found BatchMatMulInst but BatchMatMul is lowered on STC");
}

void BoundSTCFunction::fwdReluGradInst(const glow::ReluGradInst *I) {
    DCHECK(!"Found ReluGradInst but ReluGrad is lowered on STC");
}
...
//===----------------------------------------------------------------------===//
template <typename ElemTy, typename AccumulatorTy, typename BiasElemTy>
void BoundSTCFunction::fwdFullyConnectedInstQuantizedImpl(
...
template <typename ElemTy>
void BoundSTCFunction::fwdFullyConnectedInstFloatImpl(
...
void BoundSTCFunction::fwdFullyConnectedInst(
        const glow::FullyConnectedInst *I) {
...
//===----------------------------------------------------------------------===//
template <typename ElemTy, typename AccumulatorTy, typename BiasElemTy>
void BoundSTCFunction::fwdRowwiseQuantizedFullyConnectedInstImpl(
...
void BoundSTCFunction::fwdRowwiseQuantizedFullyConnectedInst(
...
template <typename ElemTy>
void BoundSTCFunction::fwdBatchedAddInstFloatImpl(
...
void BoundSTCFunction::fwdBatchedAddInst(
        const glow::BatchedAddInst *I) {
...
template <typename ElemTy>
void BoundSTCFunction::fwdBatchedReduceAddInstFloatImpl(
...
void BoundSTCFunction::fwdBatchedReduceAddInst(
...
template <typename ElemTy>
void BoundSTCFunction::fwdBatchedReduceMinInstImpl(
...
void BoundSTCFunction::fwdBatchedReduceMinInst(
...
template <typename ElemTy>
void BoundSTCFunction::fwdCumSumInstImpl(Value *input, Value *dest,
...
void BoundSTCFunction::fwdCumSumInst(glow::CumSumInst const *I) {
...
template <typename ElemTy>
void BoundSTCFunction::fwdLengthsSumInstFloatImpl(
...
void BoundSTCFunction::fwdLengthsSumInst(const LengthsSumInst *I) {
    dispatchFloatingPointImpl(fwdLengthsSumInstFloatImpl,
                              I->getData()->getElementType(), I)
}

template <typename TI>
void BoundSTCFunction::fwdSparseLengthsSumInstI8Impl(
...
void BoundSTCFunction::fwdSparseLengthsSumInstFloatImpl(
        const SparseLengthsSumInst *I) {
    staticAssertFloatingPointType(ElemTy);
...
void BoundSTCFunction::fwdSparseLengthsSumInst(
        const SparseLengthsSumInst *I) {
...
template <typename ElemTy, typename TI>
void BoundSTCFunction::fwdSparseLengthsWeightedSumInstFloatImpl(
...
template <typename TI>
void BoundSTCFunction::fwdSparseLengthsWeightedSumInstI8Impl(
        const SparseLengthsWeightedSumInst *I) {
...
void BoundSTCFunction::fwdSparseLengthsWeightedSumGradInst(
...
template <typename ElemTy>
void BoundSTCFunction::fwdEmbeddingBagInstFloatImpl(
...
void BoundSTCFunction::fwdEmbeddingBagInst(const EmbeddingBagInst *I) {
    dispatchFloatingPointImpl(fwdEmbeddingBagInstFloatImpl,
                              I->getData()->getElementType(), I);
}

template <typename T, typename AccumT, typename TI>
void BoundSTCFunction::fwdRowwiseQuantizedSparseLengthsWeightedSumImpl(
...
void BoundSTCFunction::fwdRowwiseQuantizedSparseLengthsWeightedSumInst(
        const RowwiseQuantizedSparseLengthsWeightedSumInst *I) {
...
void BoundSTCFunction::fwdEmbeddingBagByteRowwiseOffsetsImpl(
...
void BoundSTCFunction::fwdEmbeddingBagByteRowwiseOffsetsInst(
        const EmbeddingBagByteRowwiseOffsetsInst *I) {
    switch (I->getDest()->getElementType()) {
        case ElemKind::FloatTy:
...
void BoundSTCFunction::fwdLengthsToRangesInst(
...
void BoundSTCFunction::fwdLengthsRangeFillInst(
...
template <typename ElemTy>
void BoundSTCFunction::fwdSparseToDenseInstImpl(
...
void BoundSTCFunction::fwdSparseToDenseInst(
        const SparseToDenseInst *I) {
    dispatchArithmeticImpl(fwdSparseToDenseInstImpl,
                           I->getDest()->getElementType(), I);
}

void BoundSTCFunction::fwdSparseToDenseMaskInst(
...
void BoundSTCFunction::fwdTopKInst(const TopKInst *I) {
...
void BoundSTCFunction::fwdArgMaxInst(const ArgMaxInst *I) {
    auto argmaxW = getTensor(I->getSrc());
    auto inW = getTensor(I->getDest());
...
void BoundSTCFunction::fwdAllocActivationInst(
        const AllocActivationInst *I) {
    getOrCreateTensor(I);
}

void BoundSTCFunction::fwdDeallocActivationInst(
...
/// tensor.
void BoundSTCFunction::fwdDebugPrintInst(const DebugPrintInst *I) {
    auto *V = I->getSrc();
    llvm::outs() << I->getName() << ": ";
...
void BoundSTCFunction::fwdTraceEventInst(const TraceEventInst *I) {
...
//===----------------------------------------------------------------------===//
void BoundSTCFunction::fwdQuantizationProfileInst(
...
void BoundSTCFunction::fwdQuantizeInst(const glow::QuantizeInst *I) {
...
void BoundSTCFunction::fwdDequantizeInst(
...
template <class eTy>
void BoundSTCFunction::fwdRescaleQuantizedInstImpl(
...
void BoundSTCFunction::fwdRescaleQuantizedInst(
...
void BoundSTCFunction::fwdIntLookupTableInst(
...
void BoundSTCFunction::fwdConvertToInst(const glow::ConvertToInst *I) {
...
template <typename ElemTy>
void BoundSTCFunction::fwdBatchedPairwiseDotProductInstImpl(
...
void BoundSTCFunction::fwdBatchedPairwiseDotProductInst(
        const BatchedPairwiseDotProductInst *I) {
...
template <typename ElemTy>
void BoundSTCFunction::fwdBatchedPairwiseDotProductGradInstImpl(
...
void BoundSTCFunction::fwdBatchedPairwiseDotProductGradInst(
        const BatchedPairwiseDotProductGradInst *I) {
...
template <typename ElemTy>
void BoundSTCFunction::fwdFlipInstImpl(const FlipInst *I) {
...
void BoundSTCFunction::fwdFlipInst(const FlipInst *I) {
...
template <typename T>
void BoundSTCFunction::fwdNonMaxSuppressionInstImpl(
...
void BoundSTCFunction::fwdNonMaxSuppressionInst(
        glow::NonMaxSuppressionInst const *I) {
...
void BoundSTCFunction::fwdAudioSpectrogramInstFloatImpl(
...
void BoundSTCFunction::fwdAudioSpectrogramInst(
        glow::AudioSpectrogramInst const *I) {
...
void BoundSTCFunction::fwdMFCCInstFloatImpl(glow::MFCCInst const *I) {
...
void BoundSTCFunction::fwdMFCCInst(glow::MFCCInst const *I) {
    auto spectrogramTy = I->getSpectrogram()->getElementType();
