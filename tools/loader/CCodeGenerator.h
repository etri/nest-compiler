...
public:
  ...
  void generateInitialization(Loader &loader, std::string &writeFileC,
                              std::ofstream *writeFileBin, Node &n);
  void generateInference(Loader &loader, std::string inputName,
                         std::string &writeFileC, std::string inAryStr,
                         Node &n);
  void generateFree(Loader &loader, std::string inputName,
                    std::string &writeFileC, std::string inAryStr, Node &n);

  void declareConstVar(std::string &wfilec, Constant *node);
  void allocConstVar(std::string &wfilec, std::ofstream *wfileb,
                     Constant *node);
