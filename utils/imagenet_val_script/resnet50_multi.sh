...
declare -a profiles=("goldfish_resnet50_bin1000" "1000_resnet50_bin1000" "10000_resnet50_bin1000")
...
for profile in "${profiles[@]}"; do
    for clip in "${clips[@]}"; do
      ...
      --validation-images-dir=/home/jemin/development/dataset/imagenet2012_processed \
      --image-classifier-cmd="../../cmake-build-release/bin/image-classifier-cl-nonfusion
