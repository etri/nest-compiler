...
int main(int argc, char **argv) {
  ...
  uint8_t *mutableWeightVarsAddr =
      initMutableWeightVars(squeezenet_config, "data_0");
  // uint8_t *activationsAddr = initActivations(squeezenet_config);

  // Perform the computation.
  squeezenet_load_module(0);
  int errCode = squeezenet(0, mutableWeightVarsAddr, 0);
  ...
  int maxIdx = dumpInferenceResults(squeezenet_config, mutableWeightVarsAddr,
                                    "softmaxout_1");
