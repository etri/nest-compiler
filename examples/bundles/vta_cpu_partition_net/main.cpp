...
//      initConstantWeights("p2.weights.bin", p2_config);
  uint8_t *mutableWeightVarsAddr2 = copyMutableWeightVarsWithAlloc(p2_config, "resnetv10_stage1_conv0_fwd__2", resultVar1);
...
//  }
  ...
  float* resultVar2 = getInferenceResultVar(p2_config, mutableWeightVarsAddr2, "resnetv10_stage1_relu0_fwd__1");
  uint8_t *constantWeightVarsAddr3 =
      initConstantWeights("p3.weights.bin", p3_config);
  uint8_t *mutableWeightVarsAddr3 = copyMutableWeightVarsWithAlloc(p3_config, "resnetv10_stage1_relu0_fwd__1", resultVar2);
...
//  }
  ...
  float* resultVar3 = getInferenceResultVar(p3_config, mutableWeightVarsAddr3, "resnetv10_stage1_conv1_fwd__2");
//  uint8_t *constantWeightVarsAddr4 =
//      initConstantWeights("p4.weights.bin", p4_config);
  uint8_t *mutableWeightVarsAddr4 = copyMutableWeightVarsWithAlloc(p4_config, "resnetv10_stage1_conv1_fwd__2", resultVar3);
  copyMutableWeightVarsWithoutAlloc(p4_config, mutableWeightVarsAddr4, "resnetv10_pool0_fwd__1", resultVar0);
...
//  }
  ...
  float* resultVar4 = getInferenceResultVar(p4_config, mutableWeightVarsAddr4, "resnetv10_stage1_activation0__1");
  uint8_t *constantWeightVarsAddr5 =
      initConstantWeights("p5.weights.bin", p5_config);
  uint8_t *mutableWeightVarsAddr5 = copyMutableWeightVarsWithAlloc(p5_config, "resnetv10_stage1_activation0__1", resultVar4);
...
//  }
  ...
  float* resultVar5 = getInferenceResultVar(p5_config, mutableWeightVarsAddr5, "resnetv10_stage1_conv2_fwd__2");
  //uint8_t *constantWeightVarsAddr6 =
  //    initConstantWeights("p6.weights.bin", p6_config);
  uint8_t *mutableWeightVarsAddr6 = copyMutableWeightVarsWithAlloc(p6_config, "resnetv10_stage1_conv2_fwd__2", resultVar5);
...
//  }
  ...
  float* resultVar6 = getInferenceResultVar(p6_config, mutableWeightVarsAddr6, "resnetv10_stage1_relu1_fwd__1");
  uint8_t *constantWeightVarsAddr7 =
      initConstantWeights("p7.weights.bin", p7_config);
  uint8_t *mutableWeightVarsAddr7 = copyMutableWeightVarsWithAlloc(p7_config, "resnetv10_stage1_relu1_fwd__1", resultVar6);
...
//  }
  ...
  float* resultVar7 = getInferenceResultVar(p7_config, mutableWeightVarsAddr7, "resnetv10_stage1_conv3_fwd__2");
  // uint8_t *constantWeightVarsAddr8 =
  //     initConstantWeights("p8.weights.bin", p8_config);
  uint8_t *mutableWeightVarsAddr8 = copyMutableWeightVarsWithAlloc(p8_config, "resnetv10_stage1_conv3_fwd__2", resultVar7);
  copyMutableWeightVarsWithoutAlloc(p8_config, mutableWeightVarsAddr8, "resnetv10_stage1_activation0__1", resultVar4);
...
//  }
  ...
  float* resultVar8 = getInferenceResultVar(p8_config, mutableWeightVarsAddr8, "resnetv10_stage1_activation1__1");
  uint8_t *constantWeightVarsAddr9 =
      initConstantWeights("p9.weights.bin", p9_config);
  uint8_t *mutableWeightVarsAddr9 = copyMutableWeightVarsWithAlloc(p9_config, "resnetv10_stage1_activation1__1", resultVar8);
...
//  }
  ...
  float* resultVar9 = getInferenceResultVar(p9_config, mutableWeightVarsAddr9, "resnetv10_stage2_conv0_fwd__2");
//  uint8_t *constantWeightVarsAddr10 =
//      initConstantWeights("p10.weights.bin", p10_config);
  uint8_t *mutableWeightVarsAddr10 = copyMutableWeightVarsWithAlloc(p10_config, "resnetv10_stage2_conv0_fwd__2", resultVar9);
...
//  }
  ...
  uint8_t *mutableWeightVarsAddr11 = copyMutableWeightVarsWithAlloc(p11_config, "resnetv10_stage1_activation1__1", resultVar8);
...
//  }
  ...
  float* resultVar10 = getInferenceResultVar(p10_config, mutableWeightVarsAddr10, "resnetv10_stage2_relu0_fwd__1");
  uint8_t *constantWeightVarsAddr12 =
      initConstantWeights("p12.weights.bin", p12_config);
  uint8_t *mutableWeightVarsAddr12 = copyMutableWeightVarsWithAlloc(p12_config, "resnetv10_stage2_relu0_fwd__1", resultVar10);
...
//  }
  ...
  float* resultVar11 = getInferenceResultVar(p11_config, mutableWeightVarsAddr11, "resnetv10_stage2_conv2_fwd__2");
  float* resultVar12 = getInferenceResultVar(p12_config, mutableWeightVarsAddr12, "resnetv10_stage2_conv1_fwd__2");
 // uint8_t *constantWeightVarsAddr13 =
 //     initConstantWeights("p13.weights.bin", p13_config);
  uint8_t *mutableWeightVarsAddr13 = copyMutableWeightVarsWithAlloc(p13_config, "resnetv10_stage2_conv2_fwd__2", resultVar11);
  copyMutableWeightVarsWithoutAlloc(p13_config, mutableWeightVarsAddr13, "resnetv10_stage2_conv1_fwd__2", resultVar12);
...
//  }
  ...
  float* resultVar13 = getInferenceResultVar(p13_config, mutableWeightVarsAddr13, "resnetv10_stage2_activation0__1");
  uint8_t *constantWeightVarsAddr14 =
      initConstantWeights("p14.weights.bin", p14_config);
  uint8_t *mutableWeightVarsAddr14 = copyMutableWeightVarsWithAlloc(p14_config, "resnetv10_stage2_activation0__1", resultVar13);
...
//  }
  ...
  float* resultVar14 = getInferenceResultVar(p14_config, mutableWeightVarsAddr14, "resnetv10_stage2_conv3_fwd__2");
  //uint8_t *constantWeightVarsAddr16 =
  //    initConstantWeights("p16.weights.bin", p16_config);
  uint8_t *mutableWeightVarsAddr15 = copyMutableWeightVarsWithAlloc(p15_config, "resnetv10_stage2_conv3_fwd__2", resultVar14);
...
//  }
  ...
  float* resultVar15 = getInferenceResultVar(p16_config, mutableWeightVarsAddr15, "resnetv10_stage2_relu1_fwd__1");
  uint8_t *constantWeightVarsAddr16 =
      initConstantWeights("p16.weights.bin", p16_config);
  uint8_t *mutableWeightVarsAddr16 = copyMutableWeightVarsWithAlloc(p16_config, "resnetv10_stage2_relu1_fwd__1", resultVar15);
...
//  }
  ...
  float* resultVar16 = getInferenceResultVar(p16_config, mutableWeightVarsAddr16, "resnetv10_stage2_conv4_fwd__2");
//  uint8_t *constantWeightVarsAddr18 =
//      initConstantWeights("p18.weights.bin", p18_config);
  uint8_t *mutableWeightVarsAddr17 = copyMutableWeightVarsWithAlloc(p17_config, "resnetv10_stage2_conv4_fwd__2", resultVar16);
  copyMutableWeightVarsWithoutAlloc(p17_config, mutableWeightVarsAddr17, "resnetv10_stage2_activation0__1", resultVar13);
...
//  }
  ...
  float* resultVar17 = getInferenceResultVar(p18_config, mutableWeightVarsAddr17, "resnetv10_stage2_activation1__1");
  uint8_t *constantWeightVarsAddr18 =
      initConstantWeights("p18.weights.bin", p18_config);
  uint8_t *mutableWeightVarsAddr18 = copyMutableWeightVarsWithAlloc(p18_config, "resnetv10_stage2_activation1__1", resultVar17);
...
//  }
  ...
  float* resultVar18 = getInferenceResultVar(p18_config, mutableWeightVarsAddr18, "resnetv10_stage3_conv0_fwd__2");
//   uint8_t *constantWeightVarsAddr19 =
//       initConstantWeights("p19.weights.bin", p19_config);
  uint8_t *mutableWeightVarsAddr19 = copyMutableWeightVarsWithAlloc(p19_config, "resnetv10_stage3_conv0_fwd__2", resultVar18);
...
//  }
  ...
  // float* resultVar19 = getInferenceResultVar(p19_config, mutableWeightVarsAddr19, "tmp__19");
  uint8_t *constantWeightVarsAddr20 =
      initConstantWeights("p20.weights.bin", p20_config);
  uint8_t *mutableWeightVarsAddr20 = copyMutableWeightVarsWithAlloc(p20_config, "resnetv10_stage2_activation1__1", resultVar17);
...
//  }
  ...
  float* resultVar19 = getInferenceResultVar(p19_config, mutableWeightVarsAddr19, "resnetv10_stage3_relu0_fwd__1");
  uint8_t *constantWeightVarsAddr21 =
      initConstantWeights("p21.weights.bin", p21_config);
  uint8_t *mutableWeightVarsAddr21 = copyMutableWeightVarsWithAlloc(p21_config, "resnetv10_stage3_relu0_fwd__1", resultVar19);
...
//  }
  ...
  float* resultVar21 = getInferenceResultVar(p21_config, mutableWeightVarsAddr21, "resnetv10_stage3_conv1_fwd__2");
  float* resultVar20 = getInferenceResultVar(p20_config, mutableWeightVarsAddr20, "resnetv10_stage3_conv2_fwd__2");
//  uint8_t *constantWeightVarsAddr22 =
//      initConstantWeights("p22.weights.bin", p22_config);
  uint8_t *mutableWeightVarsAddr22 = copyMutableWeightVarsWithAlloc(p22_config, "resnetv10_stage3_conv1_fwd__2", resultVar21);
  copyMutableWeightVarsWithoutAlloc(p22_config, mutableWeightVarsAddr22, "resnetv10_stage3_conv2_fwd__2", resultVar20);
...
//  }
  ...
  float* resultVar22 = getInferenceResultVar(p22_config, mutableWeightVarsAddr22, "resnetv10_stage3_activation0__1");
  uint8_t *constantWeightVarsAddr23 =
      initConstantWeights("p23.weights.bin", p23_config);
  uint8_t *mutableWeightVarsAddr23 = copyMutableWeightVarsWithAlloc(p23_config, "resnetv10_stage3_activation0__1", resultVar22);
...
//  }
  ...
  float* resultVar23 = getInferenceResultVar(p23_config, mutableWeightVarsAddr23, "resnetv10_stage3_conv3_fwd__2");
//   uint8_t *constantWeightVarsAddr24 =
//       initConstantWeights("p24.weights.bin", p24_config);
  uint8_t *mutableWeightVarsAddr24 = copyMutableWeightVarsWithAlloc(p24_config, "resnetv10_stage3_conv3_fwd__2", resultVar23);
...
//  }
  ...
  float* resultVar24 = getInferenceResultVar(p24_config, mutableWeightVarsAddr24, "resnetv10_stage3_relu1_fwd__1");
  uint8_t *constantWeightVarsAddr25 =
      initConstantWeights("p25.weights.bin", p25_config);
  uint8_t *mutableWeightVarsAddr25 = copyMutableWeightVarsWithAlloc(p25_config, "resnetv10_stage3_relu1_fwd__1", resultVar24);
...
//  }
  ...
  float* resultVar25 = getInferenceResultVar(p25_config, mutableWeightVarsAddr25, "resnetv10_stage3_conv4_fwd__2");
//  uint8_t *constantWeightVarsAddr26 =
//      initConstantWeights("p26.weights.bin", p26_config);
  uint8_t *mutableWeightVarsAddr26 = copyMutableWeightVarsWithAlloc(p26_config, "resnetv10_stage3_conv4_fwd__2", resultVar25);
  copyMutableWeightVarsWithoutAlloc(p26_config, mutableWeightVarsAddr26, "resnetv10_stage3_activation0__1", resultVar22);
...
//  }
  ...
  float* resultVar26 = getInferenceResultVar(p26_config, mutableWeightVarsAddr26, "resnetv10_stage3_activation1__1");
  uint8_t *constantWeightVarsAddr27 =
      initConstantWeights("p27.weights.bin", p27_config);
  uint8_t *mutableWeightVarsAddr27 = copyMutableWeightVarsWithAlloc(p27_config, "resnetv10_stage3_activation1__1", resultVar26);
...
//  }
  ...
  float* resultVar27 = getInferenceResultVar(p27_config, mutableWeightVarsAddr27, "resnetv10_stage4_conv0_fwd__2");
//   uint8_t *constantWeightVarsAddr28 =//
//       initConstantWeights("p28.weights.bin", p28_config);
  uint8_t *mutableWeightVarsAddr28 = copyMutableWeightVarsWithAlloc(p28_config, "resnetv10_stage4_conv0_fwd__2", resultVar27);
...
//  }
  ...
  float* resultVar28 = getInferenceResultVar(p28_config, mutableWeightVarsAddr28, "resnetv10_stage4_relu0_fwd__1");
  uint8_t *constantWeightVarsAddr29 =
      initConstantWeights("p29.weights.bin", p29_config);
  uint8_t *mutableWeightVarsAddr29 = copyMutableWeightVarsWithAlloc(p29_config, "resnetv10_stage4_relu0_fwd__1", resultVar28);
  copyMutableWeightVarsWithoutAlloc(p29_config, mutableWeightVarsAddr29, "resnetv10_stage3_activation1__1", resultVar26);
...
//  }
  ...
  float* resultVar29_1 = getInferenceResultVar(p29_config, mutableWeightVarsAddr29, "resnetv10_stage4_conv2_fwd__2");
  float* resultVar29_2 = getInferenceResultVar(p29_config, mutableWeightVarsAddr29, "resnetv10_stage4_conv1_fwd__2");
//  uint8_t *constantWeightVarsAddr30 =
//      initConstantWeights("p30.weights.bin", p30_config);
  uint8_t *mutableWeightVarsAddr30 = copyMutableWeightVarsWithAlloc(p30_config, "resnetv10_stage4_conv2_fwd__2", resultVar29_1);
  copyMutableWeightVarsWithoutAlloc(p30_config, mutableWeightVarsAddr30, "resnetv10_stage4_conv1_fwd__2", resultVar29_2);
...
//  }
  ...
  float* resultVar30 = getInferenceResultVar(p30_config, mutableWeightVarsAddr30, "resnetv10_stage4_activation0__1");
  uint8_t *constantWeightVarsAddr31 =
      initConstantWeights("p31.weights.bin", p31_config);
  uint8_t *mutableWeightVarsAddr31 = copyMutableWeightVarsWithAlloc(p31_config, "resnetv10_stage4_activation0__1", resultVar30);
...
//  }
  ...
  float* resultVar31 = getInferenceResultVar(p31_config, mutableWeightVarsAddr31, "resnetv10_stage4_conv3_fwd__2");
//  uint8_t *constantWeightVarsAddr32 =
//      initConstantWeights("p32.weights.bin", p32_config);
  uint8_t *mutableWeightVarsAddr32 = copyMutableWeightVarsWithAlloc(p32_config, "resnetv10_stage4_conv3_fwd__2", resultVar31);
...
//  }
  ...
  float* resultVar32 = getInferenceResultVar(p32_config, mutableWeightVarsAddr32, "resnetv10_stage4_relu1_fwd__1");
  uint8_t *constantWeightVarsAddr33 =
      initConstantWeights("p33.weights.bin", p33_config);
  uint8_t *mutableWeightVarsAddr33 = copyMutableWeightVarsWithAlloc(p33_config, "resnetv10_stage4_relu1_fwd__1", resultVar32);
...
//  }
  ...
  float* resultVar33 = getInferenceResultVar(p33_config, mutableWeightVarsAddr33, "resnetv10_stage4_conv4_fwd__2");
  uint8_t *constantWeightVarsAddr34 =
      initConstantWeights("p34.weights.bin", p34_config);
  uint8_t *mutableWeightVarsAddr34 = copyMutableWeightVarsWithAlloc(p34_config, "resnetv10_stage4_conv4_fwd__2", resultVar33);
  copyMutableWeightVarsWithoutAlloc(p34_config, mutableWeightVarsAddr34, "resnetv10_stage4_activation0__1", resultVar30);
...
//  uint8_t *mutableWeightVarsAddr35 = copyMutableWeightVarsWithAlloc(p35_config, "resnetv10_dense0_fwd", resultVar34);
//  uint8_t *activationsAddr35 = initActivations(p35_config);
//
//  // Perform the computation.
//  int errCode35 =
...
//  dumpInferenceResults(p35_config, mutableWeightVarsAddr35, "resnetv10_dense0_fwd__1");
//
