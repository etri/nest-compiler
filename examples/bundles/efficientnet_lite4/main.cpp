...
int main(int argc, char **argv) {
  ...
  uint8_t *constantWeightVarsAddr =
      initConstantWeights("efficientnet_lite4.weights.bin", efficientnet_lite4_config);
  uint8_t *mutableWeightVarsAddr = initMutableWeightVars(efficientnet_lite4_config, "images_0");
  uint8_t *activationsAddr = initActivations(efficientnet_lite4_config);

  // Perform the computation.
  int errCode =
      efficientnet_lite4(constantWeightVarsAddr, mutableWeightVarsAddr, activationsAddr);
...
//  dumpInferenceResults(resnet18v2_config, mutableWeightVarsAddr, "resnetv22_dense0_fwd__1");
  int maxIdx = dumpInferenceResults(efficientnet_lite4_config, mutableWeightVarsAddr, "Softmax_0");
